...
<!-- Topbar -->
	<div class="topbar_wrap">
			...
			<ul>
				...
				<li><a href="<?php echo U("Home/login/index");?>"><span>[登录]</span></a></li>
				<li><a href="<?php echo U("Home/reg/index");?>" target="_blank"><span>[注册]</span></a></li>
...
<div id="login_container" class="login_shell">
		<div class="login_form clearfix">
			...
			<form name="loginForm" id="loginForm" method="post" action="<?php echo U("Home/login/checklogin");?>" >
			<input type="hidden" id="needWekey" name="needWekey" value="0" />
				<dl>
					...
					<dd class="create_id">
						<a href="<?php echo U("Home/reg/index");?>"><i></i>创建账户</a>
					</dd>
				</dl>
			</form>
