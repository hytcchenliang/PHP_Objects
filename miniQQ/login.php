	...
	<div class="logbody">
		<form action="index.php" method="post">
			<div class="logbodyL">
				...
				<span class="spansaomiao">使用QQ手机版扫描二维码</span>
			</div>
			<div class="logbodyR">
				...
				<div class="mima">
					<input name="password" type="text" class="userpwd"/>
				</div>	
				<input type="submit" id="tijiao" value="登 录">
				<a id="btnzhuce" href="zhuce.php">注册</a>
				<span class="spanjoin">感谢您留步参与Smart QQ的试验</span>
			</div>
		</form>
	</div>
	<div class="phoneqq">使用手机访问SmartQQ</div>
	<?php
	   session_start();
